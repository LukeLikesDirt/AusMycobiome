...
# low-quality of the reads on distal ends. Primer removal is therefore omitted
# from the workflow but removal primers and discarding read without primers
# or primer mismatches is recommend when possible.
#
# The read tracking function follows reads library-by-library and to evaluate 
# mean library-wise statistics. The function expects file names for test samples
# to begin with the letter 's', for example, 's1_L001_R1_001.fastq.gz'. I do 
# this to ignore the in particular the negative because they have low abundances
# and bias mean estimates. You can rename test samples, amend the 'track_reads'
# or remove the 'track_reads' function from the main script if required.
...
RAW_DATA="../../data/bioinformatics/01.Raw_data"
QUALITY_TRIMMED_DIR="../../data/bioinformatics/02.Quality_trimmed"
ITS_EXTRACTED_DIR="../../data/bioinformatics/03.ITS_extracted"
QUALITY_FILTERED_DIR="../../data/bioinformatics/04.Quality_filtered_test"

# Define summary files for tracking reads
TRACK_READS_TRIMMED="../../data/bioinformatics/summary_trimmed_test.txt"
TRACK_READS_ITS="../../data/bioinformatics/summary_its_test.txt"
TRACK_READS_QUAL_FILTERED="../../data/bioinformatics/summary_quality_filtered_test.txt"
