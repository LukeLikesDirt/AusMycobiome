...
aus_gf_coords_cortinarius <- fread(
  "data/australian_microbiome_GF/cortinarius.csv"
  ) %>%
  filter(
    # Exclude Antarctic
    latitude > -65
...
# Save the map
ggsave("../output/plots/map_cortinarius.jpg", cortinarius_maps,
       width = 15.75, height = 5.1, units = "cm", dpi = 600)
ggsave("../output/plots/map_cortinarius.tiff", cortinarius_maps,
